...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::remote_runner::remote_set_step_assignment,
            ...
            commands::features::step_set_assignment,
            ...
            commands::features::sync_reconcile,
            commands::features::feature_divergence,
            ...
            commands::ask::ask_create,
            commands::ask::ask_list,
            commands::ask::ask_load,
            ...
            commands::ask::ask_export_canvas_to_file,
            ...
            commands::discovery::discovery_publish_integration_mr,
