...
function AppInner() {
  ...
  const commandPaletteEntries = useMemo(() => [
    ...
    { id: 'nav-remote-inbox', label: 'Remote runs', description: 'Return inbox for runs on remote machines', category: 'action' as const, icon: <Server className="w-4 h-4" />, onSelect: () => navigate({ kind: 'remote-inbox' }) },
