 ...
 * placeholders: no turn has been taken, and nothing has been proposed. The
 * name it was filed under is not a turn — `discovery::create` writes no
 * message, so the transcript is empty until the user says something.
 */
