 ...
 */
function PullRequestRowImpl({ pullRequest, now }: PullRequestRowProps): React.ReactElement {
  ...
  return (
    <a
      ...
      className="group block rounded-xl border border-white/5 bg-black/20 p-4 transition-colors hover:border-cyan-500/30 hover:bg-white/5"
    >
      <div className="flex items-start gap-3">
        <div className="min-w-0 flex-1 space-y-2">
          <div className="flex flex-wrap items-center gap-2">
            <h3 className="font-heading text-sm font-medium text-white line-clamp-2">{row.title}</h3>
