...
const DOT_COLORS: Record<string, string> = {
  ...
  awaiting_mr:          'bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.8)]',
  pr_ready:             'bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.8)]',
  running:              'bg-cyan-500 shadow-[0_0_8px_rgba(6,182,212,0.8)]',
  verifying:            'bg-violet-500 shadow-[0_0_8px_rgba(139,92,246,0.8)]',
  ...
  parked:               'bg-amber-500 shadow-[0_0_8px_rgba(245,158,11,0.8)]',
  'needs-credentials':  'bg-amber-500 shadow-[0_0_8px_rgba(245,158,11,0.8)]',
  needs_credentials:    'bg-amber-500 shadow-[0_0_8px_rgba(245,158,11,0.8)]',
  ...
  'over-budget':        'bg-ruby-500 shadow-[0_0_8px_rgba(239,68,68,0.8)]',
...
const PILL_COLORS: Record<string, string> = {
  ...
  awaiting_mr:          'bg-emerald-500/10 text-emerald-400 border-emerald-500/20',
  pr_ready:             'bg-emerald-500/10 text-emerald-400 border-emerald-500/20',
  ...
  parked:               'bg-amber-500/10 text-amber-400 border-amber-500/20',
  'needs-credentials':  'bg-amber-500/10 text-amber-400 border-amber-500/20',
  needs_credentials:    'bg-amber-500/10 text-amber-400 border-amber-500/20',
  ...
  'over-budget':        'bg-ruby-500/10 text-ruby-400 border-ruby-500/20',
